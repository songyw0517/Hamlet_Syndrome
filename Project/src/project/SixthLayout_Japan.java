...
public class SixthLayout_Japan extends JPanel {
	// instance data
	...
	private String[] restaurantName = { "images/Japan_Rice1.png", "images/Japan_Rice2.jpg", "images/Japan_Rice3.jpg",
			"images/Japan_Noodle1.png", "images/Japan_Noodle2.png", "images/Japan_Noodle3.png", "images/Japan_Etc1.png",
			"images/Japan_Etc2.png", "images/Japan_Etc3.jpg" };// 음식점 사진의 이미지 파일 경로 및 이름을 배열로 저장
	private String[] detailsName = { "images/Japan_Rice1_details.png", "images/Japan_Rice2_details.png",
			"images/Japan_Rice3_details.png", "images/Japan_Noodle1_details.png", "images/Japan_Noodle2_details.png",
			"images/Japan_Noodle3_details.png", "images/Japan_Etc1_details.png", "images/Japan_Etc2_details.png",
			"images/Japan_Etc3_details.png" };// 음식점에 대한 설명 사진의 이미지 파일 경로 및 이름을 배열로 저장

	public SixthLayout_Japan(JFrame fifthLayout, JPanel prePanel, int kind, JPanel firstPanel) {
