...
public class FifthLayout_Japan extends JPanel {
	// instance data
	 ...
	 * propessorPanel : 교수님 사진을 띄우는 패널 firstPanel : 홈 버튼이 눌렸을 경우 이동할 패널(firstLayout의
	 * 패널)
	 */
	...
	public FifthLayout_Japan(JFrame thirdLayout, JPanel prePanel, JPanel firstPanel) {// 생성자
	...
	private class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (B == Rice) {// 밥이 눌렸을 경우
				...
				new SixthLayout_Japan(fifthLayout, primary, 1, firstPanel);
			} else if (B == Noodle) {// 면이 눌렸을 경우
				primary.setVisible(false);
				new SixthLayout_Japan(fifthLayout, primary, 2, firstPanel);
			} else if (B == Etc) {// 기타가 눌렸을 경우
				primary.setVisible(false);
				new SixthLayout_Japan(fifthLayout, primary, 3, firstPanel);
