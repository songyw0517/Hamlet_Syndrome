...
public class SixthLayout_Korea extends JPanel {
	// instance data
	...
	private String[] restaurantName = { "images/Korea_Rice1.png", "images/Korea_Rice2.png", "images/Korea_Rice3.png",
			"images/Korea_Noodle1.png", "images/Korea_Noodle2.png", "images/Korea_Noodle3.png", "images/Korea_Etc1.png",
			"images/Korea_Etc2.png", "images/Korea_Etc3.png" };;// 음식점 사진의 이미지 파일 경로 및 이름을 배열로 저장
	private String[] detailsName = { "images/Korea_Rice1_details.png", "images/Korea_Rice2_details.png",
			"images/Korea_Rice3_details.png", "images/Korea_Noodle1_details.png", "images/Korea_Noodle2_details.png",
			"images/Korea_Noodle3_details.png", "images/Korea_Etc1_details.png", "images/Korea_Etc2_details.png",
			"images/Korea_Etc3_details.png" };// 음식점에 대한 설명 사진의 이미지 파일 경로 및 이름을 배열로 저장

	public SixthLayout_Korea(JFrame fifthLayout, JPanel prePanel, int kind, JPanel firstPanel) {
