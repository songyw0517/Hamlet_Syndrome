...
public class SixthLayout_USA extends JPanel {
	// instance data
	...
	private String[] restaurantName = { "images/USA_Rice1.png", "images/USA_Rice2.png", "images/USA_Rice3.png",
			"images/USA_Noodle1.png", "images/USA_Noodle2.png", "images/USA_Noodle3.png", "images/USA_Etc1.png",
			"images/USA_Etc2.png", "images/USA_Etc3.png" };// 음식점 사진의 이미지 파일 경로 및 이름을 배열로 저장
	private String[] detailsName = { "images/USA_Rice1_details.png", "images/USA_Rice2_details.png",
			"images/USA_Rice3_details.png", "images/USA_Noodle1_details.png", "images/USA_Noodle2_details.png",
			"images/USA_Noodle3_details.png", "images/USA_Etc1_details.png", "images/USA_Etc2_details.png",
			"images/USA_Etc3_details.png" };// 음식점에 대한 설명 사진의 이미지 파일 경로 및 이름을 배열로 저장

	public SixthLayout_USA(JFrame fifthLayout, JPanel prePanel, int kind, JPanel firstPanel) {
